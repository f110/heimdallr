...
// +kubebuilder:rbac:groups=proxy.f110.dev,resources=rolebindings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=proxy.f110.dev,resources=rolebindings/status,verbs=get;update;patch
...
// +kubebuilder:rbac:groups=*,resources=pods;secrets;configmaps;services;cronjobs;deployments;poddisruptionbudgets;ingresses;ingressclasses;persistentvolumeclaims;serviceaccounts;roles;rolebindings,verbs=get;list;watch;create;update;patch;delete
