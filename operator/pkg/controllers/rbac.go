...
// +kubebuilder:rbac:groups=*,resources=pods;secrets;configmaps;services;cronjobs;deployments;poddisruptionbudgets;ingresses;ingressclasses;persistentvolumeclaims,verbs=get;list;watch;create;update;patch;delete
